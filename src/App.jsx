...
const App = () => {
  ...
  const displayWizardUnscheduled = useMemo(() => {
    ...
    return Array.from(uniqueMap.values())
      ...
      .sort((a, b) => (a.name || '').localeCompare(b.name || '', 'zh-Hant'));
  }, [wizardUnscheduled, students, wizardPlannedCountByStudent]);
                            ...
                            >
                              {items.map((item) => (
                                <div
                                  ...
                                  className={`relative rounded px-2 py-1 pr-6 text-xs cursor-move ${
                                    item.source === 'manual'
                                ...
                                >
                                  <button
                                    ...
                                    className="absolute top-1 right-1 w-4 h-4 rounded-full bg-white border text-gray-500 hover:bg-red-50 hover:text-red-600 flex items-center justify-center leading-none"
                                    title="移除此課程"
                                  >
                                    ×
                                  </button>
                                  ...
                                  <div className="font-medium pr-3">
                                    {item.timeStr}-{addMinutesToTimeStr(item.timeStr, CLASS_DURATION)} {item.name}
                                  </div>
